...
declare const popconfirmProps: {
  ...
  readonly confirmButtonType: EpPropFinalized<StringConstructor, "" | "text" | "default" | "info" | "primary" | "success" | "warning" | "danger", unknown, "primary", boolean>;
  readonly cancelButtonType: EpPropFinalized<StringConstructor, "" | "text" | "default" | "info" | "primary" | "success" | "warning" | "danger", unknown, "text", boolean>;
