import { defineComponent, reactive, computed, toRefs, nextTick, provide, openBlock, createElementBlock, unref, normalizeClass, createElementVNode, normalizeStyle, createVNode, createBlock, createCommentVNode, Fragment, renderList } from 'vue';
            ...
            createElementVNode("div", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(markList), (item, key) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  class: normalizeClass([
                    unref(ns).e("stop"),
                    unref(ns).e("marks-stop"),
                    !_ctx.range && _ctx.modelValue >= item.point ? unref(ns).e("marks-stop__reached") : ""
                  ]),
                  onClick: ($event) => onStopClick(item)
                }, null, 14, _hoisted_3);
              }), 128))
            ]),
            createElementVNode("div", {
...
var Slider = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:\\OneDrive\\\u684C\u9762\\bhopMain\\element-plus\\packages\\components\\slider\\src\\slider.vue"]]);
