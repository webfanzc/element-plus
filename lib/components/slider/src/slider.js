  ...
  setup(__props, { expose, emit }) {
    ...
    const onStopClick = async (item) => {
      if (props.range)
        return;
      await vue.nextTick();
      emit(event.CHANGE_EVENT, item.point);
    };
            ...
            vue.createElementVNode("div", null, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(markList), (item, key) => {
                return vue.openBlock(), vue.createElementBlock("div", {
                  ...
                  class: vue.normalizeClass([
                    vue.unref(ns).e("stop"),
                    vue.unref(ns).e("marks-stop"),
                    !_ctx.range && _ctx.modelValue >= item.point ? vue.unref(ns).e("marks-stop__reached") : ""
                  ]),
...
var Slider = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "D:\\OneDrive\\\u684C\u9762\\bhopMain\\element-plus\\packages\\components\\slider\\src\\slider.vue"]]);
